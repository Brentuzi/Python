...
for i in range(5):
    ...
    if n1 > n2:
     print('Выиграл', igrok1, ' ', n1)
     wins1+=1
    elif n1 < n2:
     print('Выиграл', igrok2, ' ', n2)
     wins2 += 1
    else:
     print('Ничья')
     wins2 += 1
...
if score1 > score2:
 print('Выиграл', igrok1, ' Очки:', score1, ' Выйгрышных раундов ', wins1)
elif n1 < n2:
 print('Выиграл', igrok2, ' Очки:', score2, ' Выйгрышных раундов ', wins2)
else:
 print('Ничья')